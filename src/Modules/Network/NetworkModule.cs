...
namespace VessieFramework.Modules.Network
{
    /// <summary>
    /// Módulo de otimização para Network
    /// </summary>
    public class NetworkModule : IModule
    {
        public string Name => "Network Module";
        public string Description => "Gerencia otimizações e monitoramento de Network";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Network module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Network module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
