...
namespace VessieFramework.Modules.Cloud
{
    /// <summary>
    /// Módulo de otimização para Cloud
    /// </summary>
    public class CloudModule : IModule
    {
        public string Name => "Cloud Module";
        public string Description => "Gerencia otimizações e monitoramento de Cloud";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Cloud module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Cloud module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
        ...
        public Task<OptimizationResult> Optimize(OptimizationContext context)
        {
            ...
            {
                Success = true,
                Message = "Cloud optimization completed",
