...
namespace VessieFramework.Modules.Telemetry
{
    /// <summary>
    /// Módulo de otimização para Telemetry
    /// </summary>
    public class TelemetryModule : IModule
    {
        public string Name => "Telemetry Module";
        public string Description => "Gerencia otimizações e monitoramento de Telemetry";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Telemetry module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Telemetry module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
