...
namespace VessieFramework.Modules.Power
{
    /// <summary>
    /// Módulo de otimização para Power
    /// </summary>
    public class PowerModule : IModule
    {
        public string Name => "Power Module";
        public string Description => "Gerencia otimizações e monitoramento de Power";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Power module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Power module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
        ...
        public Task<OptimizationResult> Optimize(OptimizationContext context)
        {
            ...
            {
                Success = true,
                Message = "Power optimization completed",
