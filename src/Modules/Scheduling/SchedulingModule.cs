...
namespace VessieFramework.Modules.Scheduling
{
    /// <summary>
    /// Módulo de otimização para Scheduling
    /// </summary>
    public class SchedulingModule : IModule
    {
        public string Name => "Scheduling Module";
        public string Description => "Gerencia otimizações e monitoramento de Scheduling";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Scheduling module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Scheduling module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
