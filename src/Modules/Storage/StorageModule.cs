...
namespace VessieFramework.Modules.Storage
{
    /// <summary>
    /// Módulo de otimização para Storage
    /// </summary>
    public class StorageModule : IModule
    {
        public string Name => "Storage Module";
        public string Description => "Gerencia otimizações e monitoramento de Storage";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Storage module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Storage module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
