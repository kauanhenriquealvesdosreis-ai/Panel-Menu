...
namespace VessieFramework.Modules.Process
{
    /// <summary>
    /// Módulo de otimização para Process
    /// </summary>
    public class ProcessModule : IModule
    {
        public string Name => "Process Module";
        public string Description => "Gerencia otimizações e monitoramento de Process";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Process module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Process module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
