...
namespace VessieFramework.Modules.Container
{
    /// <summary>
    /// Módulo de otimização para Container
    /// </summary>
    public class ContainerModule : IModule
    {
        public string Name => "Container Module";
        public string Description => "Gerencia otimizações e monitoramento de Container";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Container module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Container module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
