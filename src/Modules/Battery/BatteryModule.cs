...
namespace VessieFramework.Modules.Battery
{
    /// <summary>
    /// Módulo de otimização para Battery
    /// </summary>
    public class BatteryModule : IModule
    {
        public string Name => "Battery Module";
        public string Description => "Gerencia otimizações e monitoramento de Battery";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Battery module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Battery module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
