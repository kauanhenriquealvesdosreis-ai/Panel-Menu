...
namespace VessieFramework.Modules.Disk
{
    /// <summary>
    /// Módulo de otimização para Disk
    /// </summary>
    public class DiskModule : IModule
    {
        public string Name => "Disk Module";
        public string Description => "Gerencia otimizações e monitoramento de Disk";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Disk module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Disk module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
