...
namespace VessieFramework.Modules.Advanced
{
    /// <summary>
    /// Módulo de otimização para Advanced
    /// </summary>
    public class AdvancedModule : IModule
    {
        public string Name => "Advanced Module";
        public string Description => "Gerencia otimizações e monitoramento de Advanced";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "Advanced module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "Advanced module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
