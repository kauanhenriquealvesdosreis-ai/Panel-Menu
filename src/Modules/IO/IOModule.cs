...
namespace VessieFramework.Modules.IO
{
    /// <summary>
    /// Módulo de otimização para IO
    /// </summary>
    public class IOModule : IModule
    {
        public string Name => "IO Module";
        public string Description => "Gerencia otimizações e monitoramento de IO";
        ...
        public ModuleResult Load()
        {
            ...
            try
            {
                ...
                result.Message = "IO module loaded successfully";
            }
            catch (Exception ex)
            {
        ...
        public ModuleResult Unload()
        {
            ...
            {
                IsEnabled = false;
                result.Message = "IO module unloaded";
            }
            catch (Exception ex)
            {
                result.Success = false;
        ...
        public Task<OptimizationResult> Optimize(OptimizationContext context)
        {
            ...
            {
                Success = true,
                Message = "IO optimization completed",
